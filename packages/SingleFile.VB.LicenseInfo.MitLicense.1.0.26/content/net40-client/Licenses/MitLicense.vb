...
<Acknowledgment(Author:="Christoph Hafner", SourceUrl:="https://www.nuget.org/packages/SingleFile.VB.LicenseInfo.MitLicense/1.0.26", License:=GetType(MitLicense), Comment:="Leave this acknowledgment 'as-is' and you are legally licensed.")> _
Friend NotInheritable Class MitLicense
    ...
    ''' <summary>Returns a <see cref="String" /> that represents this instance (the <see cref="Name"/>).</summary>
